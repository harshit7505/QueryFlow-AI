      ...
      <div className="max-w-[1400px] mx-auto">
            ...
            <div className="relative w-full md:w-[400px] bg-white/5 p-5 rounded-2xl border border-white/5 overflow-hidden backdrop-blur-sm">
              <div className="flex gap-12 animate-marquee whitespace-nowrap">
                ...
                {[...systemLogs, ...systemLogs].map((log, i) => (
                  <span key={i} className="text-[14px] md:text-[9px] font-mono text-gray-500 tracking-tighter">
                    [{log}]
                  </span>
                ))}
              </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 border-t border-white/5 pt-12">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a href="https://github.com/harshit7505" target="_blank" rel="noreferrer" className="text-[14px] md:text-[11px] uppercase font-black text-white hover:text-[#C9A84C] transition-colors tracking-widest italic mt-2">Source Code</a>
          </div>
