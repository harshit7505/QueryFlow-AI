    ...
    <div className="bg-[#080A0F] min-h-screen text-white pt-32 md:pt-40 overflow-x-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 pb-40">
        ...
        >
          ...
          <span className="text-[#C9A84C]">COMMS</span>
        </motion.h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-8 md:p-20">
          ...
          <motion.div 
            ...
            className="lg:col-span-8 bg-[#0D1117] p-8 md:p-12 rounded-[2.5rem] border border-white/5"
          >
            ...
            <form action="https://formspree.io/f/mpqoljwe" method="POST" className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col">
                  ...
                  <input type="text" name="name" required className="bg-[#080808] border border-white/10 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-[#C9A84C]/50 transition-colors" placeholder="John Doe" />
                </div>
                <div className="flex flex-col">
                  <label className="text-[14px] md:text-[10px] uppercase tracking-[0.2em] text-gray-500 mb-2 font-black">Entity / Node</label>
                  <input type="text" name="entity" className="bg-[#080808] border border-white/10 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-[#C9A84C]/50 transition-colors" placeholder="Company Name" />
                </div>
              </div>

              <div className="flex flex-col">
                <label className="text-[14px] md:text-[10px] uppercase tracking-[0.2em] text-gray-500 mb-2 font-black">Secure Relay (Email)</label>
                <input type="email" name="email" required className="bg-[#080808] border border-white/10 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-[#C9A84C]/50 transition-colors" placeholder="operator@entity.com" />
              </div>
              ...
              <div className="flex flex-col">
                ...
                <textarea rows="5" name="message" required className="bg-[#080808] border border-white/10 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-[#C9A84C]/50 transition-colors resize-none" placeholder="State your requirements..." />
              </div>
          ...
          >
            {/* Location Node */}
            <div className="bg-[#0D1117] p-8 rounded-[2rem] border border-white/5">
              <span className="text-[#C9A84C] material-symbols-outlined text-3xl mb-4">location_on</span>
            ...
            <div className="bg-[#0D1117] p-8 rounded-[2rem] border border-white/5">
              ...
              <p className="text-gray-500 text-sm leading-relaxed flex flex-col items-start">
                <a href="mailto:harshit7505@gmail.com" className="hover:text-[#66dd8b] transition-colors">
                  harshit7505@gmail.com
                </a>
              </p>
            </div>
